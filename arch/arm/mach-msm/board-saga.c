...
*/
	struct pm8xxx_gpio_init_info gpio24 = {
		PM8058_GPIO_PM_TO_SYS(SAGA_GREEN_LED),
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
			.output_value   = 1,
	...
	struct pm8xxx_gpio_init_info gpio25 = {
		PM8058_GPIO_PM_TO_SYS(SAGA_AMBER_LED),
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
			.output_value   = 1,
...
static struct pm8xxx_irq_platform_data pm8xxx_irq_pdata = {
	...
	.devirq			= MSM_GPIO_TO_INT(SAGA_PMIC_GPIO_INT),
...
/* parallel CAMERA interfaces */
	GPIO_CFG(SAGA_CAM1_PD, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SAGA_CAM2_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SAGA_CAM2_PD, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
...
{
	if (gpio_tlmm_config(GPIO_CFG(SAGA_PMIC_GPIO_INT, 1, GPIO_CFG_INPUT,
				  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE))
		pr_err("%s: gpio_tlmm_config (gpio=%d) failed\n",
		       __func__, SAGA_PMIC_GPIO_INT);
...
static uint32_t usb_ID_PIN_output_table[] = {
	GPIO_CFG(SAGA_GPIO_USB_ID_PIN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
};


static uint32_t usb_ID_PIN_input_table[] = {
	GPIO_CFG(SAGA_GPIO_USB_ID_PIN, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
};
...
static struct smsc911x_platform_config smsc911x_config = {
	.phy_interfsaga	= PHY_INTERFSAGA_MODE_MII,
...
static unsigned aux_pcm_gpio_off[] = {
	PCOM_GPIO_CFG(138, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_CFG_2MA),   /* PCM_DOUT */
	PCOM_GPIO_CFG(139, 0, GPIO_INPUT, GPIO_NO_PULL, GPIO_CFG_2MA),   /* PCM_DIN  */
	PCOM_GPIO_CFG(140, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_CFG_2MA),   /* PCM_SYNC */
	PCOM_GPIO_CFG(141, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_CFG_2MA),   /* PCM_CLK  */
};
...
/*//For panel, but it is redundant because we'll register spi.modalias as "spi_display"
	{
		.modalias       = "spi_qsd",
		.mode           = SPI_MODE_3,
		.bus_num        = 0,
...
static uint32_t qsd_spi_gpio_on_table[] = {
	PCOM_GPIO_CFG(45, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	PCOM_GPIO_CFG(47, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	PCOM_GPIO_CFG(48, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	PCOM_GPIO_CFG(87, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA),
	PCOM_GPIO_CFG(89, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA)
};

static uint32_t qsd_spi_gpio_off_table[] = {
	PCOM_GPIO_CFG(45, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_6MA),
	PCOM_GPIO_CFG(47, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_6MA),
	PCOM_GPIO_CFG(48, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA),
	PCOM_GPIO_CFG(87, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_6MA),
	PCOM_GPIO_CFG(89, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA)
 };
...
static struct msm_gpio sdc4_sleep_cfg_data[] = {
	{GPIO_CFG(58, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
			"sdc4_clk"},
	{GPIO_CFG(59, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
			"sdc4_cmd"},
	{GPIO_CFG(60, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
			"sdc4_dat_3"},
	{GPIO_CFG(61, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
			"sdc4_dat_2"},
...
static int mbp_config_interfsaga_mode(int state)
{
	if (state) {
...
static int mbp_power_up(void)
{
	...
	udelay(300);
	rc = mbp_config_interfsaga_mode(MBP_ON);
	if (rc)
		goto exit;
	pr_debug("%s: mbp_config_interfsaga_mode() done\n", __func__);
