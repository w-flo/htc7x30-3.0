...
static unsigned aux_pcm_gpio_on[] = {
  GPIO_CFG(SPADE_GPIO_BT_PCM_OUT, 1, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
  GPIO_CFG(SPADE_GPIO_BT_PCM_IN, 1, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
  GPIO_CFG(SPADE_GPIO_BT_PCM_SYNC, 1, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
  GPIO_CFG(SPADE_GPIO_BT_PCM_CLK, 1, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static unsigned aux_pcm_gpio_off[] = {
  GPIO_CFG(SPADE_GPIO_BT_PCM_OUT, 0, GPIO_CFG_INPUT,
			GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
  GPIO_CFG(SPADE_GPIO_BT_PCM_IN, 0, GPIO_CFG_INPUT,
                      GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
  GPIO_CFG(SPADE_GPIO_BT_PCM_SYNC, 0, GPIO_CFG_INPUT,
			GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
  GPIO_CFG(SPADE_GPIO_BT_PCM_CLK, 0, GPIO_CFG_INPUT,
                      GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};
...
static struct q5v2audio_analog_ops ops = {
	...
	.fm_headset_enable = spade_snddev_hsed_pamp_on,
	.fm_speaker_enable = spade_snddev_poweramp_on,
};
